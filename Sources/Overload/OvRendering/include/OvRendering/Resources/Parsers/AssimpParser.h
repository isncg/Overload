...
namespace OvRendering::Resources::Parsers
{
	...
	*/
	...
	private:
		...
		void ProcessMesh(void* p_transform, struct aiMesh* p_mesh, const struct aiScene* p_scene, std::vector<OvRendering::Geometry::AssimpVertex>& p_outVertices, std::vector<uint32_t>& p_outIndices, OvRendering::Resources::MeshRigInfo& rigInfo);
	};
}