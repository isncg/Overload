...
) : PanelWindow(p_title, p_opened, p_windowSettings)
{
	...
	/* Component select + button */
	{
		...
		componentSelectorWidget.choices.emplace(13, "Animation");
		...
		addComponentButton.ClickedEvent += [&componentSelectorWidget, this]
		{
			...
			case 13: GetTargetActor()->AddComponent<CAnimation>();			break;
			}
		...
		componentSelectorWidget.ValueChangedEvent += [this, &addComponentButton](int p_value)
		{
			...
			case 13: defineButtonsStates(GetTargetActor()->GetComponent<CAnimation>());			return;
			}
		};
